...
{ 
    ...
    private void OnTemperaturavoltouaonormal()
    {
         if ((this.Temperatura <= limiteSuperior) && (disparadoEventoLimiteSuperior == true)) 
        {
            LimiteSuperiorEvent("A temperatura voltou ao normal");
            disparadoEventoLimiteSuperior = false;
        }
    }
}